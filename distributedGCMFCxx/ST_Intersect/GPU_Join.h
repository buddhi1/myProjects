...
__global__ void Segment_Intersect_Join(coord_t *bCoords, coord_t * oCoords, long pairNum, int* jCompactVector, int* jxy2IndexList, long *bPFVNum, long* oPFVNum, long* bEdgePSCounter, long* oEdgePSCounter, poly_size_t *bEdgeList, poly_size_t* oEdgeList, char* segIntersectJoinFlag){
...
//=========================== Get_CMBR =============================
__global__ void Get_CMBR(long pairNum, int* jCompactVector, char* piPFlag, char* piPType, coord_t* bMBR, coord_t* oMBR, coord_t* cMBR, char *joinFlag){
...
//=========================== Count_CMF =============================
__global__ void Count_CMF(coord_t *bCoords, coord_t * oCoords, coord_t* cMBR, long pairNum2, int* jCompactVector, int* jTempIndexList, int* bVNum, int* oVNum, long *bPFVNum, long* oPFVNum, int* bEdgeCounter, int* oEdgeCounter, char* joinFlag){
...
//=========================== Count_CMF_1D =============================
__global__ void Count_CMF_1D(coord_t *bCoords, coord_t * oCoords, coord_t* cMBR, long pairNum2, int* jCompactVector, int* jTempIndexList, int* bVNum, int* oVNum, long *bPFVNum, long* oPFVNum, int* bEdgeCounter, int* oEdgeCounter, char* joinFlag){
...
//============================ PointInPolygonTest ==============================
__global__ void Point_In_Polygon_Test(coord_t* bCoords, coord_t* oCoords, long pipNum, int* jxyVector, int* jPiPIndexList, char* pipType, long* bVPSNum, long* oVPSNum, char* pipJoinFlag, char* joinFlag){
...
//=========================== Segment_Intersect_Join =============================
__global__ void Segment_Intersect_Join2(coord_t *bCoords, coord_t * oCoords, long pairNum, int* jCompactVector, int* jxy2IndexList, long *bPFVNum, long* oPFVNum, long* bEdgePSCounter, long* oEdgePSCounter, long *workLoadPSCounter, long workLoadNum, poly_size_t *bEdgeList, poly_size_t* oEdgeList, char* joinFlag){
