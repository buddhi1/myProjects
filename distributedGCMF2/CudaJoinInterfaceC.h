...
class CudaJoinInterface
{
 ...
 polygonLayer* populateLayerData(list<GEOSGeometry*>* layer, int* debug_param);
 
 void createReducers(Config *args, pair<map<int,list<GEOSGeometry*>* > *, map<int,list<GEOSGeometry*>* >* >* cellPairMap);
